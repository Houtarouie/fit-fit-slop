...
export default function UserProfileDetail({ 
  ...
  // Calculate today's mock stats for this user
  ...
  return (
    <div className="meal-logger-container animate-fade-in">
      ...
      <button 
        ...
        style={{ display: "inline-flex", alignCenter: "center", gap: "0.5rem", padding: "0.5rem 1rem" }}
      ...
      <div className="glass-card mb-2">
        <div className="d-flex justify-between align-center" style={{ flexWrap: "wrap", gap: "1rem" }}>
          <div className="d-flex align-center gap-1">
            <div className="meal-photo-thumb" style={{ width: "64px", height: "64px", fontSize: "2rem", borderRadius: "50%" }}>
              {user.avatar || "👤"}
            </div>
            <div>
              <h2 style={{ fontSize: "1.3rem", fontWeight: "700" }}>{user.displayName}</h2>
      ...
      <div className="glass-card mb-2">
        ...
        <div className="d-flex gap-2" style={{ marginTop: "1.5rem", fontSize: "0.8rem", color: "var(--text-muted)", borderTop: "1px solid var(--border-color)", paddingTop: "1rem" }}>
          ...
          <div>🏋️‍♂️ <strong>Activity:</strong> {getActivityLabel(user.activityLevel)}</div>
        </div>
      </div>
